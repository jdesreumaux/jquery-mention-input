$(function () {
  ...
  $('.set-prepopulate').click(function() {
     $('textarea.mention').val('');
     $('textarea.mention').mentionsInput('prepopulate','Rio FERDINAND', 90, 'contact',true);
     $('textarea.mention').mentionsInput('prepopulate','Zlatan IBRAHIMOVIC', 91, 'contact',true);
     $('textarea.mention').mentionsInput('prepopulate','David BECKHAM', 92, 'contact',true);
  
  
    $('textarea.mention').elastic();
  }) ;
